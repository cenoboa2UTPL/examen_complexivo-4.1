...
<head>
    ...
    <link rel="icon" type="image/x-icon"
        href="{{ count($this->BusinesData()) > 0 ? $this->asset('empresa/' . $this->BusinesData()[0]->logo) : $this->asset('img/essalud.ico') }}" />
            ...
            $('#logout_').click(function(evento) {
                ...
                Swal.fire({
                    title: "Estas seguro de cerrar tu sistema " + ((PROFILE_ !== 'admin_general' &&
                        PROFILE_ !== 'Director' && PROFILE_ !== 'Médico' && PROFILE_!== 'Admisión' && PROFILE_!== 'Paciente') ? "Farmacia" : "Clínica") + " ?",
