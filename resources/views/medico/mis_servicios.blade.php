                        ...
                        <div class="table-responsive">
                           <caption> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-auto col-lg-auto col-md-auto col-12">
                                    <button class="btn_blue form-control" id="open_modal_new_servicio">Agregar uno nuevo <i class='bx bx-plus'></i></button>
                                </div>
                            </div>
                           </caption>
  ...
  $.ajax({
    ...
    success:function(response)
    {
        ...
        if(response.response.length> 0)
        {
            ...
            tr+= `<tr>
                <td>`+contador+`</td>
                <td>`+element.name_servicio+`</td> <td>`+(element.precio_servicio != null ? element.precio_servicio:'0.00')+`</td>
                <td class='d-none'>`+element.id_servicio+`</td>
                <td>
                <button id='delete' class='btn btn-danger btn-sm'><i class='bx bx-x'></i></button>    
                <button id='editar' class='btn btn-warning btn-sm'><i class='bx bx-pencil'></i></button>    
                </td>
                </tr>`;
        });
