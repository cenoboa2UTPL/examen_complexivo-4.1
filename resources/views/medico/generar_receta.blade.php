...
@section("contenido")
  <div class="card">
    <ul class="nav nav-tabs nav-fill" role="tablist" id="ul_recetas">
        ...
        <li class="nav-item">
            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#generar_receta"
               id="generar_receta_" aria-controls="navs-justified-profile" aria-selected="false" style="color:#466e9b">
               <img src="{{$this->asset('img/icons/unicons/citas_programados.ico')}}" class="menu-icon" alt="" style="height: 20px"> <b>Generar recetas electrónicas</b>
            </button>
        </li>
    ...
    <div class="tab-content">
        <div class="tab-pane fade show active " id="generar_receta" role="tabpanel">
            <div class="card-text m-3 border border-success p-3" style="border-radius: 5%">
                 <h5>Datos del paciente</h5>
                 <div class="row">
                    <div class="col-12">
                        <div class="input-group">
                            <input type="text" class="form-control"  id="input_paciente" placeholder="Paciente....">
                            <button class="btn btn-primary" id="buscar_paciente"><i class="fas fa-search"></i></button>
                        </div>
                        <span class="text-danger" style="display: none" id="error_paciente"><i class="fas fa-exclamation-triangle"></i> El paciente es requerido!</span>
                    </div>
                 </div>
            </div>
            <div class="card-text mt-4">
                <div class="row p-3">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                        <label for=""><b>Medicamento <span class="text-danger">*</span></b></label>
                        <div class="input-group">
                            <input type="text" id="medicamento" class="form-control">
                            <button class="btn btn-outline-primary" id="open_modal_productos"><i class="fas fa-search"></i></button>
                        </div>
                        <span class="text-danger" style="display: none" id="error_producto"><i class="fas fa-exclamation-triangle"></i> El producto es requerido!</span>
                    </div>
                    <div class="col-xl-8 col-lg-8 col-md-6 col-12">
                        <label for=""><b>Frecuencia <span class="text-danger">*</span></b></label>
                        <div class="form-group">
                            <input type="text" id="frecuencia" class="form-control">
                        </div>
                        <span class="text-danger" style="display: none" id="error_frecuencia"><i class="fas fa-exclamation-triangle"></i> La frecuencia es requerido!</span>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                        <label for=""><b>Tomar por | usarlo por <span class="text-danger">*</span></b></label>
                        <div class="form-group">
                            <input type="text" id="dosis" class="form-control" placeholder="# de días..">
                        </div>
                        <span class="text-danger" style="display: none" id="error_dosis"><i class="fas fa-exclamation-triangle"></i> El tiempo de tratamiento es requerido!</span>
                    </div>
        
                    <div class="col-xl-8 col-lg-8 col-md-6 col-12">
                        <label for=""><b>Cantidad <span class="text-danger">*</span></b></label>
                        <div class="form-group">
                            <input type="text" id="cantidad" class="form-control" placeholder="# medicamentos..">
                        </div>
                        <span class="text-danger" style="display: none" id="error_cantidad"><i class="fas fa-exclamation-triangle"></i> La cantidad es requerido!</span>
                    </div>
                </div>
                ...
                <div class="row p-3">
                        ...
                        <table class="table table-bordered table-striped">
                            <thead style="background-color:dodgerblue">
                                <tr>
                                    ...
                                    <th class="text-white">Quitar</th>
                                    <th class="text-white">Medicamento</th>
                                    <th class="text-white">Frecuencia</th>
                                    <th class="text-white">Tomar por</th>
                    ...
                    <!-- AGREGADO PARA LA RECETA --->
                    <div class="mt-2 col-auto mb-3">
                        <div class="form-group">
                            <label for="tiempo_tratamiento" class="form-label"><b>Tiempo tratamiento <span class="text-danger">*</span></b></label>
                            <input type="text" class="form-control" id="tiempo_tratamiento" placeholder="Tiempo tratamiento...">
                        </div>
                    </div>
                    <!--- fin--->
                </div>
                ...
                <div class="row justify-content-center">
                   <div class="col-auto mb-5">
                    <button class="btn btn-success rounded" id="save_receta">Guardar <i class="fas fa-save"></i></button>
                   </div>
                   <div class="col-auto mb-5">
                    <button class="btn btn-danger rounded" id="cancelar_receta">Cancelar <i class="fas fa-cancel"></i></button>
                   </div>
                </div>
            </div>
        </div>

        <div class="tab-pane fade" id="recetas_generado" role="tabpanel">
            <div class="table-responsive">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card-text px-2">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped nowrap responsive" id="tabla_pacientes_search"
                        style="width: 100%">
                           <thead>
                            <tr>
                                <th>#</th>
            ...
            RecetasGenerado = $('#tabla_recetas').DataTable({
              "columnDefs": [{
                ...
                columns:[
                    ...
                    {"data":"pacientedata",render:function(pacientedata){
...
cell.innerHTML = i+1;
 ...
 function printRecetaElectronica(Tabla,Tbody)
 {
    $(Tbody).on('click','#print',function(){
        ...
        window.open(RUTA+"paciente/receta_medica?v="+Data.serie_receta,"_blank");
    });
 }
