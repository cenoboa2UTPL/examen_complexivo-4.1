  ...
  <div class="row">
    <div class="card shadow mb-4 ">
      <div class="card-header d-flex justify-content-between align-items-center justify-content-between">
        <h4 class="mb-0 d-xl-block d-lg-block d-md-block   d-none letra"  
        ">Listado de Médicos</h4>
        
        <button class="btn_info_tw float-end col-xl-3 col-lg-4 col-md-5  col-12"
...
<div class="modal fade" id="modal_editar_medico">
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #63d5e4;">
