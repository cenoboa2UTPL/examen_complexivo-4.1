          ...
          <a class="dropdown-item" href="#">
            <div class="d-flex">
              ...
              <div class="flex-grow-1">
                ...
                <small class="text-muted" id="roltext">{{$this->profile()->rol !== 'Farmacia'?($this->profile()->rol === 'admin_farmacia'?'Administrador':($this->profile()->rol === 'admin_general' ? 'Super Administrador':$this->profile()->rol)) : ($this->profile()->genero == 1?'Farmaceutico':'Farmaceutica')}}</small>
              </div>
            </div>
          </a>
        </li>
