...
@section('css')
    <style>
       #tabla_dep>thead>tr>th
        {
          background-image: radial-gradient(circle at 75.42% 13.7%, #ccd1ff 0, #9daef7 25%, #648ce9 50%, #006ddb 75%, #0052cd 100%);
            color: #fff;
            padding: 20px;
        }
        ...
        {
          background-image: radial-gradient(circle at 56.28% 14.41%, #c8fdf5 0, #b3f5f0 10%, #9becec 20%, #7ee2e9 30%, #5ad6e6 40%, #18c9e4 50%, #00bce3 60%, #00afe3 70%, #00a3e3 80%, #0098e4 90%, #008ee4 100%);
            color: #000;
            padding: 20px;
        }
...
function updateDistrito(form_id)
{
  ...
  else
  {
   if(response === 'existe')
   {
    MessageRedirectAjax('warning','Mensaje del sistema','Datos de la comuna modificado','modal_comuna_editar')
   }
   else
   {
