...
<div class="row">
     ...
     <div class="col-xl-4 col-lg-4 col-md-6  col-12 mt-xl-0 mt-lg-0 mt-1">
        <div class="card text-white" style="background-color: #ADFF2F">
            <div class="card-body">
    ...
    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-1">
        <div class="card text-white" style="background-color: #b7b9ba">
            <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                    <div class="avatar flex-shrink-0">
                        <img src="{{ $this->asset('img/icons/unicons/money.ico') }}" alt="chart success"
    ...
    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mt-1">
        <div class="card text-white" style="background-color: #0060fa">
            <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                    <div class="avatar flex-shrink-0">
                        <img src="{{ $this->asset('img/icons/unicons/money.ico') }}" alt="chart success"
    ...
    <div class="col-xl-4 col-lg-4  col-12  mt-1">
        <div class="card text-white" style="background-color: #f30b17">
            <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                    <div class="avatar flex-shrink-0">
                        <img src="{{ $this->asset('img/icons/unicons/money.ico') }}" alt="chart success"
