                 ...
                 <table class="table table-striped nowrap" id="Tabla_citas_programados" style="width: 100%"> 
                     <thead>
                         <tr>
                             ...
                             <th>ESTADO</th>
                             <th>IMPORTE</th>
                             <th>MONTO PARA EL MEDICO</th>
                             <th>MONTO PARA LA CLINICA</th>
                             <th>ACCIONES</th>
                         </tr>
                     </thead>
                 </table>
            ...
            let TablaCitasProgramados = $('#Tabla_citas_programados').DataTable({
               ...
               "columnDefs": [{
                ...
                columns:[
                    ...
                    {"data":"monto_medico",render:function(importemedico){return '<span class="badge bg-success"> S/. '+importemedico;}},
                        {"data":"monto_clinica",render:function(importeclinica){return '<span class="badge bg-primary"> S/. '+importeclinica;}},
