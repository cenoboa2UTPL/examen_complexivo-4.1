        ...
        <div class="tab-pane fade  @if($this->profile()->rol === 'Paciente') show active @endif" id="cita_form" role="tabpanel">
            ...
            <form action="" method="post" id="form_cita_medica">
                ...
                <div class="d-flex flex-row mt-3 justify-content-end">
                     ...
                     <input type="text" class="form-control" id="importe" value="0.00" @if($this->profile()->rol === 'Paciente') readonly @endif>
                     </div>
                </div>
                
                <div class="row mt-4 justify-content-center">
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5  m-xl-0 m-lg-0 m-md-0 m-1">
                        <button class="btn_info_tw save_cita" style="width: 100%"> <b>Agendar cita</b> <i class='bx bx-calendar-plus'></i></button>
                    </div>
...
<div class="modal fade" id="modal_nueva_cita" data-bs-backdrop="static">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header" style="background-image: radial-gradient(circle at 54.81% 32.05%, #d8fffe 0, #bbf9ef 25%, #94e2dc 50%, #6acccb 75%, #43bac0 100%);">
                <p class="h5 text-white mt-1"><span id="texto_cita_">Registrar cita médica</span>  <img src="{{$this->asset('img/icons/unicons/clinica.ico')}}" class="text-white" class="menu-icon" alt=""></p>
            ...
            <div class="modal-body" id="bodi_nueva_cita">
                ...
                <form action="" method="post" id="form_cita_medica_modal">
                    ...
                    <div class="row mt-5 justify-content-end">
                        <div class="col-xl-3 col-lg-3 col-md-5 col-sm-5  m-xl-0 m-lg-0 m-md-0 m-1">
                            <button class="btn_info_tw form-control save_modal_cita" >Guardar<i class='bx bxs-save'></i></button>
                        </div>
                        
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-5  m-xl-0 m-lg-0 m-md-0 m-1" style="display: none" id="anular_button">
                            <button class="btn btn-rounded btn-danger form-control anular_cita" >Anular<i class='bx bxs-save'></i></button>
                        </div>
                    </div>
                </form>  
            </div>
...
<div class="modal" id="modal_search_paciente" data-bs-backdrop="static">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header" style="background: #0ddd75">
...
<script>
  ...
  $(document).ready(function(){
    ...
    showProcedimientos(1,Especialidad.val());
   ...
   $('#modal_search_paciente').modal("show");
    ...
    $('#servicio').change(function(){
        let ServicioSeleccionado = $(this).val();
        $.ajax({
            ...
            {
                 $('#importe').val(response.servicio.precio_servicio);
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    CORREO,$('#paciente').val(),$('#medico').val(),$('#especialidad option:selected').text(),$('#servicio option:selected').text(),IMOPORTEMEDICO,IMPORTECLINICA);
                    }
                }
            }
        }
  ...
  {
    let respuesta = show(RUTA+"procedimientos_por_medico/"+id+"/"+$('#especialidad').val()+"?token_="+TOKEN);
    /// obtenemos el día por defecto
  ...
  correo_,name_data,doctora_,esp_data,serv_data,medicoimporte,clinicaimporte)
  {
    $.ajax({
            ...
            if(response.response == 'ok')
            {
                ...
                if(PROFILE_ === 'Admisión'  || PROFILE_ === 'Director'|| PROFILE_ === 'Médico')
              {
                ...
                icon:'success',
                  ...
                  window.open(RUTA+"cita-medica/generate/recibo");
                    setTimeout(() => {
                        location.href=RUTA+"crear-nueva-cita-medica";
                    }, 500);
