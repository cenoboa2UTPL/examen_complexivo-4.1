  ...
  <div class="row">
    <div class="card shadow mb-4 ">
      ...
      <div class="card-body" id="carga_">
        <div class="card-text">
          <h4 class="mb-0 d-xl-block d-lg-block d-md-block d-sm-block d-none letra float-start">Listado de pacientes</h4>
        
          <button class="btn_info_tw float-end col-xl-3 col-lg-4 col-md-5 col-sm-6 col-12"
            id="modal-create-paciente"><b >Agregar uno nuevo  <i class='bx bx-user-plus'></i></b></button>
        </div>
        <br>
        <div class="card-text">
           ...
           <div class="form-group">
            ...
            <form action="{{$this->route("paciente/upload/documentos")}}" method="post" enctype="multipart/form-data" id="form_upload_documentos">
              ...
              <div class="form-group mt-1">
                 <label for="files"><b>Seleccione los documentos[PDF] <span class="text-danger">*</span></b></label>
                 <input type="file" class="form-control" accept="application/pdf" id="documentos_file"  name="documentos[]" multiple>
              </div>

              <div class="alert alert-success mt-2" style="display: none" id="alert_upload_doc">
                 <b>Documentos pdf subidos correctamente! <i class='bx bx-check'></i></b>
              </div>

              <div class="alert alert-danger mt-2" style="display: none" id="alert_upload_doc_error">
                <b> Error al subir los documentos, solo se aceptan pdf! <i class='bx bx-x'></i></b>
             </div>

             <div class="alert alert-warning mt-2" style="display: none" id="alert_upload_doc_vacio">
              <b> Seleccione por lo menos un documento PDF! <i class='bx bxs-error-alt'></i></b>
             </div>
