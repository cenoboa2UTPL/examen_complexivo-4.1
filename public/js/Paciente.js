  ...
  var Pacientes =  $('#tabla-pacientes').DataTable({
    ...
    "columns":[
      ...
      {"defaultContent":`
        ...
        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5 col-12 m-2">
        <a href='#' class="btn rounded btn-success btn-sm" id='poliza'><i class='bx bxs-message-check'></i></a>
        </div>
  ...
  TablaDocumentos = $('#tabladocumentos').DataTable({
    ...
    columns:[
      ...
      {"data":"documento_file",render:function(documento){
        return `<a href='public/asset/documentos_pdf/`+documento+`' target='_blank' class="btn btn-primary rounded btn-sm"><i class='bx bxs-file-pdf'></i></a>
