  ...
  var Medicos_ = $('#tabla-medicos').DataTable({
    ...
    "columns":[
      ...
      {"defaultContent":`
        ...
        <button class="btn rounded btn-warning btn-sm" id='editar_medico'><i class='bx bxs-edit-alt'></i></button>
        </div>

        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5 col-12 m-2">
        <button class="btn rounded btn-danger btn-sm" id='delete_medicos'><i class='bx bxs-message-square-x'></i></button>
        </div>
