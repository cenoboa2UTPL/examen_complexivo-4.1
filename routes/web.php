...
$route->get("/egreso/create",[EgresoController::class,'create']);

$route->post("/egreso/save",[EgresoController::class,'saveCategoria']);

$route->post("/egreso/sub_categoria/save",[EgresoController::class,'saveSubCategoria']);
...
$route->get("/generate-receta-medica",[RecetaController::class,'generarRecetaView']);
...
$route->get("medico/reporte/historial/ingresos-detallado/{medico}",[MedicoController::class,'showReporteIngresosMensualMedico']);
