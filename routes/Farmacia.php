...
$route->post("/app/farmacia/venta/add_cesta/{id}",[VentaFarmaciaController::class,'addCestaProducto']);
...
$route->post("/app/farmacia/venta/quitar_producto_cesta",[VentaFarmaciaController::class,'QuitarProductoCesta']);

/// modificar cantidad de un producto añadido a la cesta del carrito
$route->post("/app/farmacia/venta/update_cantidad__producto_cesta",[VentaFarmaciaController::class,'ModifyCantidadProductoCesta']);
