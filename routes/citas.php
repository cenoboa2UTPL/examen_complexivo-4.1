...
$route->get("/paciente/orden_laboratorio/{id}",[MedicoController::class,'GenerateOrdenLaboratorioPaciente']);
...
$route->get("/cita-medica/generate/recibo",[ReporteController::class,'reciboCitaMedica']);
