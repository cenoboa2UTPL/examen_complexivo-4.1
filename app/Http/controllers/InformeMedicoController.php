    ...
    if(isset($_GET['v']) and self::profile()->rol === self::$profile[3])
     {
        ...
        if($dataRecibo)
        {
           ...
           ->first();
            ...
            $pdf->MultiCell(70,2,isset($DataEmpresa->nombre_empresa) ?  utf8__($DataEmpresa->nombre_empresa):'xxxxxxxxxxxxxxxxxxxxxxxxxx' ,0,"C");
            ...
            $pdf->SetX(34);
            $pdf->setFont("Courier","",8);
            $pdf->Cell(10,3,$dataRecibo->fecha_recibo,0,1);
            ...
            $pdf->SetX(29);
            $pdf->setFont("Courier","",8);
            $pdf->Cell(10,3,$dataRecibo->numero_recibo,0,1);
        
            $pdf->setFont("Courier","B",8);
            $pdf->Ln(3);
            $pdf->SetX(0);
            $pdf->MultiCell(74,2,utf8__($dataRecibo->apellidos." ".$dataRecibo->nombres),0,"C");
            ...
            /// codigo qr de prueba
            self::GenerateQr(isset($DataEmpresa->ruc)?$DataEmpresa->ruc:'xxxxxxxxxx'."|".$dataRecibo->numero_recibo."|".number_format($Igv_,2,","," ")."|".number_format($Total,2,","," ")."|".$dataRecibo->fecha_recibo."|".
